        ...
        actions: [
          IconButton(
              onPressed: () {
                ...
                .showSnackBar(SnackBar(content: Text('나의 아파트로 등록했습니다.')));
              },
              icon: favoriteIcon,
          ),
        ],
          ...
          Column(
            children: [
              ...
              SizedBox(
                width: MediaQuery.of(context).size.width,
                child:
                    Text('60m2 이하 평형 세대 수: ${widget.aptInfo['CAPTMPAREA60']}'),
              ),
              SizedBox(
                width: MediaQuery.of(context).size.width,
                child: Text(
                    '60m2 - 80m2 이하 평형 세대 수: ${widget.aptInfo['KAPTMPAREA85']}'),
              ),
            ],
          ),
          Container(
