...
class _MapFilterDialog extends State<MapFilterDialog> {
  ...
  final List<DropdownMenuItem<String>> _buildingDownMenuItems = [
    const DropdownMenuItem(value: '1', child: Text('1동')),
    const DropdownMenuItem(value: '2', child: Text('2동')),
    const DropdownMenuItem(value: '3', child: Text('3동 이상')),
  ];

  final List<DropdownMenuItem<String>> _peopleDownMenuItems = [
    const DropdownMenuItem(value: '0', child: Text('전부')),
    const DropdownMenuItem(value: '100', child: Text('100세대 이상')),
    const DropdownMenuItem(value: '300', child: Text('300세대 이상')),
    const DropdownMenuItem(value: '500', child: Text('500세대 이상')),
  ];
